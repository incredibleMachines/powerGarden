...
function buildSettings(data) {
	...
	var tabletString = '<table class="table table-condensed tablet-table"><thead><tr><th width="25%">Tablet Hardware Settings</th><th width="25%">Volume</th><th width="25%">Brightness</th><th width="25%">Battery Level</th></tr></thead><tbody><tr data-connection="'+data.connection_id+'" data-device="'+data.device_id+'"><td><button class="btn-mini btn-warning sleep client-'+data.connection_id+'"><i class="icon-adjust"></i> Sleep</button></td><td><input type="range" min="0" max="100" step="1" value="'+d['tablet'].volume+'" class="volume client-'+data.connection_id+'"></td><td><input type="range" min="0" max="15" step="1" value="'+d['tablet'].brightness+'" class="brightness client-'+data.connection_id+'"></td><td><div class="progress progress-info progress-striped"><div class="bar battery client-'+data.connection_id+'" style="width: 0%;"></div></div></td></tr></tbody></table>';
